...
def monitor_files(filepaths):
    ...
    file_hashes = {filepath: calculate_file_hash(filepath) for filepath in filepaths}
...
if __name__ == "__main__":
    files_to_monitor = [r"C:\Users\LAXMI BEDARKAR\OneDrive\Documents\Test.txt", r"C:\Users\LAXMI BEDARKAR\OneDrive\Documents\Test.txt"]
